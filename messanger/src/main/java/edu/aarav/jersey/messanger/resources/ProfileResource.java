...
import edu.aarav.jersey.messanger.service.ProfileService;
...
public class ProfileResource {
	...
	@Path("/{profileName}")
	@PUT
	public Profile updateProfile(@PathParam("profileName") String profileName, Profile profile) throws IllegalAccessException {
